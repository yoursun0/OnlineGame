...
export function RoomClient({ code }: { code: string }) {
  ...
  const ownTurn = Boolean(ownMember && snapshot && ((snapshot.room.state.nextMark === 'X' && ownMember.seat === 0) || (snapshot.room.state.nextMark === 'O' && ownMember.seat === 1)));
