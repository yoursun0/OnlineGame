...
const copy = {
  en: {
    ...
    stairsDescription: 'Fall the shaft, dodge traps, and keep your life gauge off zero. Solo or 2-player Shared well.', connectTitle: 'Connect Four',
  ...
  'zh-Hant': {
    ...
    ticDescription: '三格連線。規則簡單，但未必容易贏，也很難中途停手。', stairsDescription: '墜入井中、避開陷阱，別讓生命歸零。單人 Solo 或雙人 Shared 井現已可玩。',
