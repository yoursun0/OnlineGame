...
const errorTranslations: Record<string, string> = {
  ...
  'Only the host can set Table options.': '只有房主可以設定臺面規則。',
  'Wait until 結 before dealing the next hand.': '結牌後才能開下一局。',
  'Table options can only be set before the first hand.': '臺面規則只能在開局前設定。',
  'Table options are only for 打天九.': '臺面規則只適用於打天九。',
  '打天九 moves are not available yet.': '打天九尚未開放落子。',
  'Choose a legal 打天九 move.': '請選擇合法的打天九出牌。',
  'Choose a valid tile set.': '請選擇有效的牌組。',
  'The hand is over.': '這一局已經結束。',
  'No seat.': '沒有座位。',
  'Those tiles are not a legal combination.': '這些牌不是合法組合。',
  'That play does not beat the current combination.': '這套牌打不過現在的組合。',
  'Dump the same number of tiles as the lead.': '墊牌張數必須與領出相同。',
  'Must 墊 the last singleton with 0 棟.': '0 棟時最後一張必須墊。',
  'This seat has no 例牌, or a higher seat still holds the window.': '此座位沒有例牌，或上位仍佔例牌窗口。',
  'Cannot skip 例牌 now.': '現在不能跳過例牌。',
  '打天九 state is missing.': '打天九牌局狀態缺失。',
  ...
  'A LAD well supports Solo (1) or Shared (2–4) kids.': 'LAD 井支援 Solo（1 人）或 Shared（2–4 人）。',
  'This game has already started.': '遊戲已經開始，無法再加入。',
