...
- Tracker: local markdown under `.scratch/lad-realtime-spec/`.
...
- Physics constants, stair RNG, camera, controls, and art — hang on the prototype and arcade-rules tickets.
...
- Checkpoint interval numbers (seconds vs death-only) after the transport research.
